...
$edit = mysql_query("select * from rekam_medis where no_rm='".$_GET["nmr"]."'");
$editDb = mysql_fetch_assoc($edit);
	if($_POST["rm"]){
			include_once("../library/koneksi.php");
			mysql_query("update rekam_medis set kd_tindakan='".$_POST["tdk"]."', kd_obat='".$_POST["obt"]."', kd_user='".$_POST["pn"]."', no_pasien='".$_POST["pas"]."', diagnosa='".$_POST["diag"]."', resep='".$_POST["res"]."', keluhan='".$_POST["kel"]."', ket='".$_POST["ket"]."', tgl_pemeriksaan='".time()."' where no_rm='".$_GET["nmr"]."'");
